  ...
  render() {
    ...
    return (
      <div style={this._getZoomContainerStyle()}>
        <Overlay isVisible={isZoomed} defaultStyles={defaultStyles} /> {/* eslint-disable-next-line */}
        <img {...zoomImage} src={src} style={style} lazyload="on" />
        {this.props.sideForms}
...
const TmpImg = ({ src, style, ...props }) => // eslint-disable-next-line
  src ? <img {...props} src={src} style={getTmpStyle(style)} lazyload="on" /> : null
