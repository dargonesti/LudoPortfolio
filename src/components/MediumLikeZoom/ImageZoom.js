...
import { bool, func, object, shape, string , element} from 'prop-types'
...
export default class ImageZoom extends Component {
  ...
  render() {
    ...
    if(this.props.className) attrs.className=this.props.className;
      ...
      this.image && (isZoomed || this.isClosing) ?
        ...
        >
          <Zoom
            ...
            sideForms={this.props.sideForms}
          /> 
        </EventsWrapper>
       : null
    ]
  ...
  _getImageStyle() {
    const {
      isClosing,
      props: { defaultStyles, image, zoomImage, isZoomed: isZoomedP },
    ...
    return Object.assign(
      ...
      defaultStyles.image,
      isZoomedSt && zoomImage.style ? zoomImage.style : image.style,
...
ImageZoom.propTypes = {
  ...
  onZoom: func,
  onUnzoom: func,
////// Props ajouté pour ImpotX
  sideForms: element //PropTypes
}
