...
function InfoArea({ ...props }) {
  ...
  const iconClasses2 = props.useOwnIcon;
  return (
    <div className={classes.infoArea}>
      <div className={iconWrapper}>
     {/*} <i className="fa fa-file-text-o" title="test"></i>*/}
        <props.icon className={iconClasses2 ? iconClasses2 : iconClasses} />
      </div>
