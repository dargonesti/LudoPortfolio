      ...
      <div className={classes.section}>
        <div className={classes.container}>
          ...
          <div className={classes.textCenter + " " + classes.sharingArea}>
            ...
            <Button color="twitter"  aria-label="twitter">
              <i className={classes.socials + " fab fa-twitter"} /> Tweet
            </Button>
            <Button color="facebook" aria-label="facebook">
              <i className={classes.socials + " fab fa-facebook-square"} />{" "}
              Share
            </Button>
            <Button color="google" aria-label="google">
              <i className={classes.socials + " fab fa-google-plus-g"} />Share
            </Button>
            <Button color="github"  aria-label="gitHub">
